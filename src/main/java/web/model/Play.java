...
public class Play {
	...
	public static List<Play> getPlays() {
		...
		plays.add(new Play(3, "摔跤吧，爸爸", PLAY_TYPE.FILE, "印度", PLAY_RATING.CHILD, 140, LocalDate.of(2018, 05, 25) ,LocalDate.of(2018,05,30) , 33,"http://p0.meituan.net/movie/aeb864fa21d578d845b9cefc056e40cb2874891.jpg@160w_220h_1e_1c"));
		plays.add(new Play(4, "寻梦环游记", PLAY_TYPE.FILE, "欧美", PLAY_RATING.CHILD, 145, LocalDate.of(2018, 06, 25) ,LocalDate.of(2018,06,30) , 40,"http://p1.meituan.net/movie/bd5233ec3a39d4799c3521007bc74b4938450.jpg@160w_220h_1e_1c"));
